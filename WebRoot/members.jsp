...
<li class="menu_line"></li><li><a href="research?type=2" onmouseover="javascript:qiehuan(3,4)" id="mynav3" class="nav_off"><span>科学研究</span></a></li>
        ...
        <div class="dlList">
			...
			<dl>
				<dt><img src="${website.photo }"></dt>
				  ...
				  <dd class="txt">${website.subhead }</dd>
				  <dd class="dlLink"><a href="membersdetail?id=${website.id }&type=3" target="_blank">详细介绍</a></dd>
			</dl>
				</c:forEach>
		</div>
      </div>
