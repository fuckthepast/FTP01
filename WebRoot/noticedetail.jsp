...
<li><a class=nav_on id=mynav0 onmouseover=javascript:qiehuan(0,2) href="home"><span>首 页</span></a></li>
...
<li class="menu_line"></li><li><a href="Notice?type=1" onmouseover="javascript:qiehuan(2,2)" id="mynav2" class="nav_off"><span>公告发布</span></a></li>
...
<!--input begin-->
		...
		<div class="close"><a href="Notice?type=1" >[ 关闭 ]</a></div>
		<!--end-->
	</div>
