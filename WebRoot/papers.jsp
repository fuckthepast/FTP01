				...
				<div class="divMain">
					...
					<div class="txtimgList">
						<c:forEach var="website" items="${websites}">
							<dl>
								<dt>
									<a href="papersdetail?id=${website.id }&type=6" target="_blank">${website.title}</a>
								</dt>
								<dd>
									<br />
									${website.neirong}
					...
					<div class="page">
					<div class="grayr">
<form action="papers?type=6" method="post" id="navigatorForm">						
	<a href="papers?type=6&pageNumber=1">首页</a> 
	<c:if test="${pageNumber>1}">
		<a href="papers?type=6&pageNumber=${pageNumber-1}">上一页</a>
	</c:if> 
	...
	<c:if test="${pageNumber<totalPages}">
		<a href="papers?type=6&pageNumber=${pageNumber+1}">下一页</a>
	</c:if> 
	<a href="papers?type=6&pageNumber=${totalPages}">末页</a>						
</form>
			</div>
					</div>
				</div>
