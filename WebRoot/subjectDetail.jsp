...
<title>科学研究</title>
<link href="researchdetail.css" rel="stylesheet" type="text/css"/>
...
<UL></UL>
  ...
  <div id="main">
    ...
    <div class="divMain">
      ...
      <div class="mainRight">
			<h1 class="mTitle"><span>研究方向</span></h1>
...
<div class="txtMain">
<!--input begin-->
<p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${website.neirong}</p><!--input begin-->
</div>

		
		
		</div>
		<div class="close"><a href="research?type=2" >[ 关闭 ]</a></div>
</div>
      <!--end-->
